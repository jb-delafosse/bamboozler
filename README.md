...
## Development environment and release process
 ...
 - create virtualenv with Flask and Bamboozler installed into it (latter is installed in
...
install it (`pip install bamboozler.tar.gz`), ensure that configuration file exists and
`BAMBOOZLER_SETTINGS` environment variable points to it, ensure that user has access to the
